...
const BRANDS = [
  ...
  { name: 'AlphaTheta', src: '/images/brands/alphatheta.jpg', url: 'https://www.alphatheta.com' },
  { name: 'Shure', src: '/images/brands/shure.png', url: 'https://www.shure.com' },
  { name: 'QSC', src: '/images/brands/qsc.png', url: 'https://www.qsc.com' },
  { name: 'Robe', src: '/images/brands/robe.gif', url: 'https://www.rfrobe.com' },
  { name: 'Chauvet', src: '/images/brands/chauvet.gif', url: 'https://www.chauvetprofessional.com' },
  ...
  { name: 'Kramer', src: '/images/brands/kramer.webp', url: 'https://www.kramerav.com' },
  ...
  { name: 'Stageworx', src: '/images/brands/stageworx-real.gif', url: 'https://www.stageworx.com' },
]
...
export function BrandCarousel({ variant = 'black' }: { variant?: 'dark' | 'black' }) {
  ...
  return (
    <div className="overflow-hidden relative group">
      ...
      <div className="flex items-center gap-12 md:gap-16 brand-scroll group-hover:[animation-play-state:paused]">
        {items.map((brand, i) => (
          <a
            key={`${brand.name}-${i}`}
            href={brand.url}
          ...
          >
            <img
              src={brand.src}
              alt={brand.name}
              className="h-8 md:h-10 w-auto max-w-[120px] md:max-w-[150px] object-contain"
