...
export default function ProductNotFound() {
  return (
    <main className="min-h-[75vh] flex flex-col items-center justify-center px-6 py-20 bg-vsonus-black">
      ...
      <p className="text-8xl md:text-9xl font-black text-vsonus-red mb-2 leading-none tracking-tighter">404</p>
      ...
      <p className="text-gray-500 text-sm mb-10 max-w-md text-center leading-relaxed">
